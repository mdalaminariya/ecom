...
@section('content')
<div class="row">
<x-breadcum aranoz="User Update"></x-breadcum>

    <div class="col-lg-11 mx-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-3">User Update Form</h4>
                        <hr style="color: gray; width: 102%; margin-left: -1%;">
                        <form action="{{ route('management.assign.existing.role.user.update',$user->id) }}" method="post">
                            @csrf
                             <div class="row mb-3">
                                 <label for="inputEmail3" class="col-sm-3 col-form-label">Name</label>
                                <div class="col-sm-9">
                                     <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="inputEmail3" placeholder="Name" value="{{ $user->name }}">
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">E-mail</label>
                                 <div class="col-sm-9">
                                  <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" id="inputPassword3" placeholder="E-mail" value="{{ $user->email }}">
                                    <div class="invalid-feedback">
