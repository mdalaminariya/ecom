                        ...
                        <form action="{{ route('blog.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                     <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="inputEmail3" placeholder="Slug">
                                        <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">short_description</label>
                                 <div class="col-sm-9">
                                  <textarea id="shortNote" type="text" name="short_description" class="form-control @error('short_description') is-invalid @enderror"></textarea>
                                  <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">Discription</label>
                                 <div class="col-sm-9">
                                  <textarea id="longNote" type="text" name="description" class="form-control @error('description') is-invalid @enderror"></textarea>
                                  <div class="invalid-feedback">
