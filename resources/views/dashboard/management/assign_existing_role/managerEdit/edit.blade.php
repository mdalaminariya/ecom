                        ...
                        <form action="{{ route('management.assign.existing.role.manager.update',$manager->id) }}" method="post">
                            @csrf
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                     <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="inputEmail3" placeholder="Name" value="{{ $manager->name }}">
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">E-mail</label>
                                 <div class="col-sm-9">
                                  <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" id="inputPassword3" placeholder="E-mail" value="{{ $manager->email }}">
                                    <div class="invalid-feedback">
