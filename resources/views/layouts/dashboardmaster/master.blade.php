                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse" id="management">
                      <ul class="nav nav-collapse">
                        ...
                        <li>
                          <a href="{{ route('management.assign.existing.role') }}">
        ...
        @endif
             ...
             @if (auth()->user()->role == 'admin' || auth()->user()->role == 'manager')
              ...
              <li class="nav-item">
               ...
               {{-- Account Settings Route link end --}}
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="main-panel">
                  ...
                  >
                    <div class="avatar-sm">
                       @if (auth()->user()->image == 'default.png')
                            <img src="{{ asset('images/default') }}/{{ auth()->user()->image }}" alt="image profile" class="avatar-img rounded"
                            @else
                            <img src="{{ asset( 'images/profile') }}/{{ auth()->user()->image }}" alt="image profile" class="avatar-img rounded"
                            @endif
                            />
                    </div>
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('home.account.settings') }}">Account Setting</a>
                        <div class="dropdown-divider"></div>
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            ...
            <div class="copyright">
              2024, made with <i class="fas fa-bold"></i>ootstrap
            </div>
          </div>
        </footer>
      </div>
...
<!-- Chart.PieceLabel.js plugin -->
<script src="https://cdn.jsdelivr.net/npm/chart.piecelabel.js@0.9.0/Chart.PieceLabel.min.js"></script>
