...
@section('content')
    <x-breadcum aranoz="Blog Create"></x-breadcum>
                        ...
                        <form action="{{ route('blog.update', $blog->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            @method('PUT')
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                     <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="inputEmail3" placeholder="Title" value="{{ old('title', $blog->title) }}">
                                        <div class="invalid-feedback">
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                     <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="inputEmail3" placeholder="Slug" value="{{ old('slug', $blog->slug) }}">
                                        <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">short_description</label>
                                 <div class="col-sm-9">
                                  <textarea id="shortNote" type="text" name="short_description" class="form-control @error('short_description') is-invalid @enderror">{{ old('short_description', $blog->short_description) }}</textarea>
                                  <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">Discription</label>
                                 <div class="col-sm-9">
                                  <textarea id="longNote" type="text" name="description" class="form-control @error('description') is-invalid @enderror">{{ old('description', $blog->description) }}</textarea>
                                  <div class="invalid-feedback">
                           ...
                           <div class="mb-3">
                                 <img style="height: 35%; width: 35%; margin-left: 40%;" id="ecommerce" src="{{ asset('images/blog/' . $blog->thumbnail) }}" alt="Select Thumbnail">
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="justify-content-end row">
                              <div class="col-sm-9">
                                   <button type="submit" class="btn btn-success waves-effect waves-light">Add Blog</button>
                              </div>
                             </div>
                         </form>
                     </div>
